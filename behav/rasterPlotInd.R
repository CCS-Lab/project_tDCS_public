...
subjList =  unique(data[,"subject"])  # list of subjects x blocks
...
####################
# filter small
dat = data %>% filter((subject == subjList[1] & db == 2) |
                           (subject ==subjList[3] & db == 2) |
                           (subject ==subjList[9] & db == 2) |
                           (subject ==subjList[10]& db == 2) |
                           (subject ==subjList[12]& db == 2) |
                           (subject ==subjList[14]& db == 2) |
                           (subject ==subjList[25]& db == 2) |
                           (subject ==subjList[27]& db == 2) |
                           (subject ==subjList[2]& db == 1) |
                           (subject ==subjList[6]& db == 1) |
                           (subject ==subjList[8]& db == 1) |
                           (subject ==subjList[9]& db == 1) |
                           (subject ==subjList[21]& db == 1) |
                           (subject ==subjList[22]& db == 1) |
                           (subject ==subjList[27]& db == 1))

dat = data %>% filter(!(subject == subjList[1] & db == 2)) %>%
  filter(!(subject ==subjList[3] & db == 2)) %>%
  filter(!(subject ==subjList[9] & db == 2)) %>%
  filter(!(subject ==subjList[10]& db == 2)) %>%
  filter(!(subject ==subjList[12]& db == 2)) %>%
  filter(!(subject ==subjList[14]& db == 2)) %>%
  filter(!(subject ==subjList[25]& db == 2)) %>%
  filter(!(subject ==subjList[27]& db == 2)) %>%
  filter(!(subject ==subjList[2]& db == 1)) %>%
  filter(!(subject ==subjList[6]& db == 1)) %>%
  filter(!(subject ==subjList[8]& db == 1)) %>%
  filter(!(subject ==subjList[9]& db == 1)) %>%
  filter(!(subject ==subjList[21]& db == 1)) %>%
  filter(!(subject ==subjList[22]& db == 1)) %>%
  filter(!(subject ==subjList[27]& db == 1))

tmp = rep(c(subjList[1],subjList[9],subjList[10],subjList[3],subjList[12],subjList[14],subjList[25],
            subjList[27],subjList[2],subjList[6],subjList[8],861,subjList[21],subjList[22],1251),
          each = 180)
tmp = rep(1:(dim(dat)[1]/180), each = 180)
dat[,"subject"] = tmp
