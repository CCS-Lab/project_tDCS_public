...
ggplot(data = data_subj_all, aes(y = accuracy, x = ses)) +
  ...
  ggtitle(str_glue("Overall accuracy (First N = {n_first}, Second N = {n_second})"))
...
ggplot(data = data_subj_0, aes(y = accuracy, x = cond)) +
  ...
  theme_bw() + theme(legend.position = "none",
                     ...
                     axis.title.y = element_text(size = 13),
                     title = element_text(size = 15)) +
  ggtitle(str_glue("Sham: accuracy by condition (N = 31)"))
...
ggplot(data = data_subj_1, aes(y = accuracy, x = cond)) +
  ...
  theme_bw() + theme(legend.position = "none",
                     ...
                     axis.title.y = element_text(size = 13),
                     title = element_text(size = 15)) +
  ggtitle(str_glue("Anode: accuracy by condition (N = 30)"))
