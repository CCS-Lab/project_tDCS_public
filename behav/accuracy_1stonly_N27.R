...
ggplot(data = data_subj_all, aes(y = accuracy, x = ses, fill = 'purple')) +
  ...
  geom_point(data = beeswarm_all, aes(y = y, x = x), alpha = 0.5, color = "black") +
  geom_line(aes(group = subject), alpha = 0.1) +
...
#  + scale_fill_brewer(palette="PYGn") 
