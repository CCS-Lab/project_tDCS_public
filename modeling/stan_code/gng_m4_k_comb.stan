...
transformed parameters {
  ...
  vector<lower=-8,  upper=8>[N] ep;
  vector[N] b;
  vector[N] pi;
  vector<lower=0>[N] rhoRew;
  vector<lower=0>[N] rhoPun;
  vector<lower=-8,  upper=8>[N] k;
...
generated quantities {
  ...
  real<lower=-8,  upper=8> mu_ep;
  real mu_b;
  real mu_pi;
  real<lower=0> mu_rhoRew;
  real<lower=0> mu_rhoPun;
  real<lower=-8,  upper=8> mu_k;
