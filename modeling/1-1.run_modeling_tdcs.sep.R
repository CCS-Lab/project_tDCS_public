...
for (i in 1:num_subj) {
  curSubj <- subj_list[i]
  useTrials    <- Tsubj[i]
  tmp <- subset(data, subjID == curSubj)
...
params_m4_inv <- c('xi', 'ep','b','pi','rhoRew', 'rhoPun', 'beta')
params_m3_k <- c('xi', 'ep','b','pi','rho', 'k')
params_k <- c('xi', 'ep','b','pi','rhoRew', 'rhoPun', 'k')
params_k_nopi <- c('xi', 'ep','b','rhoRew', 'rhoPun', 'k')
params_pi_rp <- c('xi', 'ep','b','piRew', 'piPun', 'rhoRew', 'rhoPun')
params_k_rp_nopi <- c('xi', 'ep','b','rhoRew', 'rhoPun','kRew', 'kPun')

params_k_rp <- c('xi', 'ep','b', 'pi','rhoRew', 'rhoPun','kRew', 'kPun')
params_pi_rp_k_rp <- c('xi', 'ep','b','piRew', 'piPun','rhoRew', 'rhoPun','kRew', 'kPun')
params_pi_rp_k <- c('xi', 'ep','b','piRew', 'piPun','rhoRew', 'rhoPun','k')
...
## Load models
gng_m4_inv <- stan_model("./stan_code/gng_m4_inv.stan")
gng_m4_k <- stan_model("./stan_code/gng_m4_k.stan")
gng_m4_k_idv <- stan_model("./stan_code/gng_m4_k_idv.stan")
gng_m4_k_pm1 <- stan_model("./stan_code/gng_m4_k_pm1.stan")
gng_m4_k_swart <- stan_model("./stan_code/gng_m4_k_swart.stan")
gng_m4_k_comb <- stan_model("./stan_code/gng_m4_k_comb.stan")
gng_m3_k <- stan_model("./stan_code/gng_m3_k.stan")
gng_m4_pi_rp <- stan_model("./stan_code/gng_m4_pi-rp.stan")
gng_m4_pi_rp_k <- stan_model("./stan_code/gng_m4_pi-rp_k.stan")
...
fit_m4_pi_rp_sham <- sampling(gng_m4_pi_rp, data = dataList, iter = 4000, warmup = 2000, chains = 4, cores = 4, init = pars_init)
...
fit_m4_anode = gng_m4(data=data_anode, niter=2000, nwarmup=1000, nchain=4, ncore=4) #\\, init = pars_init)
...
fit_m4_boer_anode <- sampling(gng_m4_boer,
                             ...
                             pars = c('xi', 'ep','epRew',
                                      ...
                                      'log_lik'),
                             iter = 4000, warmup = 2000, chains = 4, cores = 4)
fit_m4_k_sep_r_anode<- sampling(gng_m4_k_sep_r, data = dataList, iter = 4000, warmup = 2000, chains = 4, cores = 4)
...
fit_m4_pi_rp_rho_anode <- sampling(gng_m4_pi_rp_rho, data = dataList,
                                  pars = c('xi', 'ep','b','piRew', 'piPun', 'rho',
                                           'mu_xi', 'mu_ep', 'mu_b', 'mu_piRew', 'mu_piPun','mu_rho',
                                           'log_lik'),
                                  init = pars_init, iter = 4000, warmup = 2000, chains = 4, cores = 4)
...
# Save output
save(fit_m4_sham, fit_m4_anode, file ='/data2/project_BRL/project_tDCS/behav/modeling/fit_m4_tdcs.RData')
...
save(fit_m4_k_sep_r_sham, fit_m4_k_sep_r_anode, file ='/data2/project_BRL/project_tDCS/behav/modeling/fit_RData/fit_tdcs_k_sep_r.RData')
...
save(fit_m4_pi_rp_rho_sham, fit_m4_pi_rp_rho_anode, file ='/data2/project_BRL/project_tDCS/behav/modeling/fit_RData/fit_tdcs_pi_rp_rho.RData')
